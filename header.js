document.addEventListener('DOMContentLoaded', () => {
    fetch('header.html')
        ...
        .then(data => {
            ...
            initHeaderScripts(); // ✅ Inizializza i comportamenti dopo inserimento
        })
        .catch(error => console.error('Errore nel caricamento dell’header:', error));
});

/**
 * ✅ Inizializza hamburger menu e sottomenu dopo che l’header è stato caricato
 */
function initHeaderScripts() {
    ...
    // Chiudi hamburger se clic su link normale
