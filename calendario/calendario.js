...
function renderCalendar() {
    ...
    const expandButton = document.getElementById('expand-button'); // Può non esserci
...
// Espandi il riquadro eventi (non più necessario con scroll automatico)
const expandButton = document.getElementById('expand-button');
if (expandButton) {
    expandButton.addEventListener('click', function () {
        const eventBox = document.getElementById('event-box');
        eventBox.style.height = 'auto'; // Altezze variabili
        eventBox.style.overflow = 'visible'; // Rimuove overflow
