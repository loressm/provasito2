...
function renderCalendar() {
    ...
    for (let day = 1; day <= numDays; day++) {
        ...
        // Verifica se ci sono troppi eventi
    ...
    // Mostra il tasto "Scopri di più" se ci sono troppi eventi
    if (hasManyEvents) {
...
// Funzione per espandere il box degli eventi
document.getElementById('expand-button').addEventListener('click', function() {
    const eventBox = document.getElementById('event-box');
    eventBox.style.height = 'auto';  // Espandi la height
    eventBox.style.overflow = 'visible'; // Rimuovi overflow
    this.style.display = 'none'; // Nascondi il tasto dopo aver cliccato
});
