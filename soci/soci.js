...
function renderMembers(members) {
  ...
  members.forEach((member, index) => {
    ...
    memberDiv.onclick = () => toggleMemberDetails(member.Nome, member);
...
function toggleMemberDetails(name, member) {
...
// Chiudere l'overlay quando si clicca sulla X
document.getElementById('close-btn').onclick = () => {
  const overlay = document.getElementById('overlay');
  overlay.style.display = 'none';
};

// Chiudere l'overlay anche se si clicca fuori dalla finestra
