...
function escapeCommasAndSpecialChars(str) {
  // Escapare la virgola e altri caratteri speciali
...
function toggleMemberDetails(member) {
  ...
  // Controlla la descrizione originale e escapata con console.log
  console.log('Descrizione originale:', member.Descrizione);
  const escapedDescription = escapeCommasAndSpecialChars(member.Descrizione);
  console.log('Descrizione escapata:', escapedDescription);

  // Usa la descrizione escapata per evitare problemi con le virgole
  overlayDetails.innerHTML = `
    ...
    <div class="member-description">
      <p><strong>Un po' di storia:</strong> ${escapedDescription}</p>
    </div>
